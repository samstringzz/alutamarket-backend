...
func Migrate() *gorm.DB {
	...
	db.AutoMigrate(&store.Store{}, &user.User{}, &product.Product{}, &cart.Cart{}, &product.Category{}, &product.HandledProduct{}, &messages.Message{}, &store.Order{}, &messages.Chat{}, &skynet.Skynet{}, &store.Transactions{})
	return db
}
