...
func Migrate() *gorm.DB {
	...
	db.AutoMigrate(&store.Store{}, &user.User{}, &product.Product{}, &cart.Cart{}, &product.Category{}, &messages.Chat{}, &product.HandledProduct{}, &messages.Message{}, &store.Order{}, &user.PasswordReset{}, &skynet.Skynet{})
	return db
}
