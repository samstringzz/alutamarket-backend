...
func Migrate() *gorm.DB {
	...
	db.AutoMigrate(&store.Store{}, &user.User{}, &product.Product{}, &cart.Cart{}, &product.Category{}, &product.HandledProduct{}, &messages.Message{}, &messages.Chat{}, &skynet.Skynet{}, &store.Order{}, &store.Transactions{})
	return db
}
