...
func (r *mutationResolver) AddToCart(ctx context.Context, input model.AddToCartItemInput) (*model.Cart, error) {
	...
	resp, err := cartHandler.AddToCart(ctx, &cartItem, uint32(input.User))
...
func (r *queryResolver) Products(ctx context.Context, store *string, limit *int, offset *int) ([]*model.Product, error) {
	productRep := app.InitializePackage(app.ProductPackage)
...
// GetWishListedProducts is the resolver for the getWishListedProducts field.
...
func (r *queryResolver) Stores(ctx context.Context, user *int, limit *int, offset *int) ([]*model.Store, error) {
